const ICONS = {
  overview: '<rect x="4" y="4" width="6" height="6" rx="1.6"/><rect x="14" y="4" width="6" height="6" rx="1.6"/><rect x="4" y="14" width="6" height="6" rx="1.6"/><rect x="14" y="14" width="6" height="6" rx="1.6"/><path d="M10 7h4M7 10v4M17 10v4M10 17h4" stroke="var(--pundi-icon-accent)" stroke-width="1.8"/>',
  transactions: '<path d="M5 6.5h14M5 12h9M5 17.5h14"/><path d="m16 9 3 3-3 3" stroke="var(--pundi-icon-accent)" stroke-width="1.8"/><circle cx="6" cy="6.5" r="1" fill="var(--pundi-icon-accent)" stroke="none"/>',
  income: '<path d="M5 19V12M10 19V8M15 19V10M20 19V5" stroke="var(--pundi-icon-accent)" stroke-width="2.4"/><path d="m14 7 3-3 3 3" stroke="currentColor" stroke-width="1.8"/><path d="M17 4v8" stroke="currentColor" stroke-width="1.8"/>',
  expenses: '<path d="M5 5v14M5 19h14"/><path d="M9 9v6M14 7v8M19 5v10" stroke="var(--pundi-icon-accent)" stroke-width="2.4"/><path d="m16 17 3 3 3-3" stroke="currentColor" stroke-width="1.8"/>',
  assets: '<circle cx="12" cy="12" r="7.5"/><circle cx="12" cy="12" r="3" stroke="var(--pundi-icon-accent)" stroke-width="2"/><path d="M12 2.8v2M21.2 12h-2M12 21.2v-2M2.8 12h2" stroke="var(--pundi-icon-accent)" stroke-width="1.8"/>',
  trading: '<path d="M5 18V9M10 18V5M15 18v-7M20 18V7" stroke="var(--pundi-icon-accent)" stroke-width="2.2"/><path d="M3.5 19.5h18M5 7.5h0M10 3.5h0M15 9.5h0M20 5.5h0"/><path d="m16 7 2 2 3-4" stroke="currentColor" stroke-width="1.8"/>',
  ...
  prospect: '<path d="m4.5 17.5 7.2-7.2 3.4 3.4 4.4-4.4" stroke="var(--pundi-icon-accent)" stroke-width="2"/><path d="M16.5 9.3h3v3"/><path d="M4 20h16"/><circle cx="7" cy="8" r="3.5"/><path d="M9.5 10.5 12 13" stroke="var(--pundi-icon-accent)" stroke-width="2"/>',
  insights: '<path d="M4 16.5c2.2 0 2.8-8 5.2-8s2.4 6.8 4.7 6.8S16.6 5 20 5" stroke="var(--pundi-icon-accent)" stroke-width="2.2"/><path d="M4 20h16M4 4v16"/><circle cx="20" cy="5" r="2" fill="var(--pundi-icon-accent)" stroke="none"/>',
...
const ALIASES = {
  '💰': 'overview', '📊': 'transactions', '🧾': 'expenses', '🤝': 'income', '📈': 'assets', '⚡': 'electricity', '🚀': 'prospect', '✨': 'insights',
