...
7. Create and add these Vercel values: `SUPABASE_URL`, `SUPABASE_ANON_KEY`, and `FINNHUB_API_KEY`. Leave `STOCK_SYMBOL_ALLOWLIST` unset if tickers will be added inside the app.
