...
assert.match(read("public/sw.js"),/pundi-shell-v8\.6\.0/,"Service-worker cache must invalidate for the v8.6.0 release");
assert.match(read("vite.config.js"),/__PUNDI_BUILD_ID__/,"Build identity must be injected automatically");
assert.match(appSource,/Pundi v8\.6\.0 · build/,"Public release identity must include version and build marker");
