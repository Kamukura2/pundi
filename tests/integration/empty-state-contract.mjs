...
for (const text of ["No income this month yet","No outstanding payments yet","No active Trading position","No budget categories","No expense this month","No equity Investment holdings"]) assert.match(app+html,new RegExp(text.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")),`${text} empty state missing`);
